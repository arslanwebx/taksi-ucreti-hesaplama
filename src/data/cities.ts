...
export interface NightTariff { enabled: boolean; multiplier: number; sourceUrl: string | null; note: string }
export interface City {
  ...
  sourceTier: 'official' | 'secondary' | 'unverified'; status: 'published' | 'draft'; categories: TaxiCategory[]; nightTariff: NightTariff; extras: string[]; local: string[];
...
export const cities: City[] = [
  ...
  {
    name: 'Ankara', slug: 'ankara', path: '/ankara-taksi-ucreti/', opening: 65, perKm: 40, minimum: 200, waitingPerHour: 420,
