...
export const posts: PostSummary[] = [
  ...
  { title: 'Sabiha Gökçen Taksi Ücreti – Hesaplama Aracı (2026)', summary: 'Sabiha Gökçen Havalimanı ile Kadıköy, Taksim, Üsküdar ve diğer varış noktaları arasındaki taksi ücretini hesaplayın.', path: '/sabiha-gokcen-taksi-ucreti/', category: 'Havalimanı Taksi Ücretleri', modified: '2026-07-27', cta: 'Sabiha Gökçen taksi rehberini aç' },
];
