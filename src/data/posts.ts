...
export const posts: PostSummary[] = [
  ...
  { title: 'Bursa Taksi Ücreti 2026: Güncel KM ve İndi Bindi Hesaplama', summary: 'Bursa açılış, kilometre ve indi-bindi tarifelerini; Ulucami, otogar, Görükle ve Mudanya rota örnekleriyle inceleyin.', path: '/bursa-taksi-ucreti/', category: 'Şehirler', modified: '2026-07-20', cta: 'Bursa taksi tarifesini incele' },
