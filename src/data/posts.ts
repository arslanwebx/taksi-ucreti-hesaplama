...
export const posts: PostSummary[] = [
  ...
  { title: 'İstanbul Taksi Ücreti Hesaplama 2026', summary: 'İstanbul açılış, kilometre ve minimum ücret kaydını; iki yaka rotaları ve ücretli geçiş notlarıyla inceleyin.', path: '/istanbul-taksi-ucreti/', category: 'Şehirler', modified: '2026-07-16', cta: 'İstanbul taksi ücretini hesapla' },
