...
const socialLinks = [
  ...
  ['LinkedIn', '', <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.94 8.5H3.56V20h3.38V8.5ZM5.25 3C4.17 3 3.3 3.87 3.3 4.95s.87 1.95 1.95 1.95 1.95-.87 1.95-1.95S6.33 3 5.25 3ZM20.7 13.4c0-3.47-1.85-5.08-4.32-5.08-1.99 0-2.88 1.09-3.38 1.86V8.5H9.62V20H13v-5.7c0-1.5.28-2.95 2.14-2.95 1.83 0 1.85 1.71 1.85 3.05V20h3.38l.33-6.6Z" /></svg>],
  ['Facebook', '', <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.5 21v-8h2.75l.41-3.12H13.5V7.89c0-.9.25-1.52 1.55-1.52h1.76V3.58c-.3-.04-1.35-.13-2.57-.13-2.54 0-4.28 1.55-4.28 4.4v2.03H7.08V13h2.88v8h3.54Z" /></svg>],
  ['Medium', '', <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6.5a1.5 1.5 0 0 0-.5-1.25L1 3.45V3h6.1l4.72 10.35L15.98 3H21v.45l-1.27 1.21a.38.38 0 0 0-.14.36v13.96a.38.38 0 0 0 .14.36L21 20.55V21h-6.37v-.45l1.32-1.24c.13-.13.13-.17.13-.36V7.67L11.02 21h-.68L4.45 8.02v9.2c-.04.25.05.5.23.67l1.72 2.09V20H1.5v-.45l1.72-2.09a.78.78 0 0 0 .22-.67V6.5H3Z" /></svg>],
] as const;
