...
export function ArticlePage({ title, heading, description, path, modified, category, readingMinutes, faqs = [], additionalSchemas = [], featuredImageAlt, children }: { title: string; heading?: string; description: string; path: string; modified: string; category: string; readingMinutes: number; faqs?: ArticleFaqItem[]; additionalSchemas?: object[]; featuredImageAlt?: string; children: ReactNode }) {
