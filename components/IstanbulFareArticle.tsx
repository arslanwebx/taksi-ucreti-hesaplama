...
export function IstanbulFareArticle() {
  ...
  return (
    <ArticlePage title={istanbulPageTitle} description={istanbulPageDescription} path="/istanbul-taksi-ucreti/" modified={city.lastVerified} category="Şehirler" readingMinutes={9} faqs={faqs} additionalSchemas={[webApplicationSchema]}>
