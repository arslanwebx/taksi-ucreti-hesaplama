...
const SITE_VERSION = 'astro-2026-07-16.2';
...
export default {
 async fetch(request:Request,env:Env):Promise<Response>{
  ...
  const payload={name,email,subject,message,city,reportedTariff,effectiveDate,source,receivedAt:new Date().toISOString()};
